...
async def startup_event():
    ...
    # Auto-seed seminars if database is empty
    try:
        ...
        if seminar_count == 0:
            print("\n⚠️  No seminars found in database. Auto-seeding sample seminars...")
            
            from datetime import timedelta
            from knowledge.seminar_topics import SEMINAR_TOPICS
            
            seminar_schedule = [
                {"topic_key": "retirement_planning_strategies", "date_offset": 5, "time": "18:00", "location_type": "virtual", "location_details": "Zoom: https://zoom.us/j/123456789", "capacity": 50},
                {"topic_key": "understanding_annuities", "date_offset": 12, "time": "19:00", "location_type": "virtual", "location_details": "Zoom: https://zoom.us/j/987654321", "capacity": 40},
                {"topic_key": "social_security_maximization", "date_offset": 18, "time": "18:30", "location_type": "hybrid", "location_details": "In-person: 123 Main St | Zoom: https://zoom.us/j/555555555", "capacity": 60},
                {"topic_key": "tax_efficient_retirement", "date_offset": 25, "time": "18:00", "location_type": "virtual", "location_details": "Zoom: https://zoom.us/j/111222333", "capacity": 45},
                {"topic_key": "medicare_healthcare_costs", "date_offset": 32, "time": "19:00", "location_type": "virtual", "location_details": "Zoom: https://zoom.us/j/444555666", "capacity": 50},
            ]
            ...
            db.commit()
            db.close()
            print(f"✅ Auto-seeded {seminars_created} sample seminars")
        else:
            print(f"✅ Found {seminar_count} existing seminars in database")
            db.close()
    except Exception as e:
        print(f"⚠️  Error auto-seeding seminars: {e}")
